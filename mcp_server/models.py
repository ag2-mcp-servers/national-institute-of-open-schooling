...
#   timestamp: 2025-06-28T15:15:56+00:00
...
class CertificateParameters(BaseModel):
    ...
    RROLL: str = Field(..., description='ROLL NO', examples=['0010003015'])
    YEAR: str = Field(..., description='YEAR', examples=['2013'])
...
class HvcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class HvcerCertificatePostResponse(BaseModel):
...
class HvcerCertificatePostResponse1(BaseModel):
...
class HvcerCertificatePostResponse2(BaseModel):
...
class HvcerCertificatePostResponse3(BaseModel):
...
class HvcerCertificatePostResponse4(BaseModel):
...
class HvcerCertificatePostResponse5(BaseModel):
...
class HvcerCertificatePostResponse6(BaseModel):
...
class SvcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class SvcerCertificatePostResponse(BaseModel):
...
class SvcerCertificatePostResponse1(BaseModel):
...
class SvcerCertificatePostResponse2(BaseModel):
...
class SvcerCertificatePostResponse3(BaseModel):
...
class SvcerCertificatePostResponse4(BaseModel):
...
class SvcerCertificatePostResponse5(BaseModel):
...
class SvcerCertificatePostResponse6(BaseModel):
